 ...
 * - To enable SUOTA over GATT only, set SUOTA_VERSION to SUOTA_VERSION_1_2
 *      and leave SUOTA_PSM undefined.
 * - To enable SUOTA over GATT and L2CAP CoC, set SUOTA_VERSION to SUOTA_VERSION_1_2
 *      and also define SUOTA_PSM to match the desired L2CAP PSM. In this case the
 *      central device can use either of both according to its preference.
 */
