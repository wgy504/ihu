...
demo_gpadc.c
	...
	with 10-bit resolution. After calibration there is a possibility to
	choose input source, sampling rate or additional features like e.g.
	chopping, oversampling, enabling attenuator or sing changing.
