...
/*
 * Register adapters in power manager
 */
...
/*
 * Initialize resources needed by devices connected to I2C and SPI busses.
 * There is no device communication at this time, just allocation of
 * synchronization primitives.
 *
 */
static void init_device_resources(void)
{
        init_adapters();
        ...
        I2C_DEVICE_INIT(BME280);
#endif
#if CFG_DEMO_SENSOR_BMM150
        I2C_DEVICE_INIT(BMM150);
#endif
#if CFG_DEMO_SENSOR_BMG160
        I2C_DEVICE_INIT(BMG160);
#endif

#if CFG_DEMO_HW_I2C_ASYNC || CFG_DEMO_AD_SPI_I2C
        I2C_DEVICE_INIT(MEM_24LC256);
        I2C_DEVICE_INIT(FM75);
#endif
        ...
        SPI_DEVICE_INIT(ADXL362);
#endif
#endif

#if CFG_DEMO_AD_GPADC || CFG_DEMO_AD_TEMPSENS
        GPADC_INIT();
#if CFG_DEMO_AD_GPADC
        demo_ad_gpadc_init();
#endif // CFG_DEMO_AD_GPADC
#endif // CFG_DEMO_AD_GPADC || CFG_DEMO_AD_TEMPSENS
}
...
static void system_init( void *pvParameters )
{
        ...
        OS_TASK_CREATE("main", main_task_func, NULL, 1000, mainTEMPLATE_TASK_PRIORITY, task_h);
