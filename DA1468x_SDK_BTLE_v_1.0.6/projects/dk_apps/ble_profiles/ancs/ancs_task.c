                                                                        ...
                                                                        ancs_client_evt_t event)
{
        ...
        /*
         * In case of other error, there's not much we can do probably - just disconnect since we
         * were not able to configure server properly and won't get notifications anyway.
         */
