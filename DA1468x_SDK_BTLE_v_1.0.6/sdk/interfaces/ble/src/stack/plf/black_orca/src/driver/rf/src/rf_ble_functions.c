 ...
 * @file rf_680.c
 *
 * @brief RF empty functions , used by BLE stack
 *
 ...
 *
 * Updated 22 april: commented 2 lines, because bits doesn't exist anymore
 *		register BLE_CNTL2_REG, bitfield BB_ONLY
 *		register BLE_RADIOCNTL0_REG, bitfield DPCORR_EN
 *
 ****************************************************************************************
 */
