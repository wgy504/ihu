...
static bc_service_t bcs = {
        .svc = {
                .read_req = handle_read_req,
                .write_req = handle_write_req,
                .connected_evt = handle_connected_evt,
                .event_sent = handle_event_sent_evt,
        },
};
...
void bcs_indicate(ble_service_t *svc, uint16_t conn_idx, bcs_body_measurement_t *meas)
{
        bc_service_t *bcs = (bc_service_t *) svc;
        uint16_t ccc_val = 0x0000;
        uint16_t max_mtu;
        ...
        ble_gatts_send_event(conn_idx, bcs->bcm_val_h, GATT_EVENT_INDICATION,
