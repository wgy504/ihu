...
typedef struct {
        ...
        /**
         * Time to scan each row in each matrix' full scan cycle.
         *
         ...
         *
         * This value is expressed as number of matrix' full scan cycles.
 ...
 *
 */
#define AD_KBSCN_CONFIG(_rows, _columns, _key_matrix, _clock_div, _row_scan_time,               \
                                                _debounce_press, _debounce_release, _cb)        \
        {                                                                                       \
