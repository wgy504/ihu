        ...
        if (IS_IN_AREA(address, CRG_TOP_BASE, sizeof(CRG_TOP_Type))
                ...
                if (address == (uint32_t)&CRG_TOP->BANDGAP_REG) {
                        ...
                        if (((dg_configBLACK_ORCA_IC_REV == BLACK_ORCA_IC_REV_A)
                                ...
                                /* In AD, the TCS setting of the BOD_CTRL2_REG is overridden. After
                                 * all, the AD bootloader does not apply it. The assertion is here
                                 * to indicate that a value was written in the TCS that will not be
                                 * used.
                                 */
                                ASSERT_WARNING(0);
                        }
