...
const struct ke_msg_handler app_spota_process_handlers[]=
{
...
{
    return (app_std_process_event(msgid, param,src_id,dest_id,msg_ret, app_spota_process_handlers,
                                         sizeof(app_spota_process_handlers)/sizeof(struct ke_msg_handler)));
}
