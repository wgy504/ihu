...
/****************************************************************************************************************/
	...
	#define CFG_NVDS_TAG_BD_ADDRESS             {0x29, 0xEF, 0xA5, 0x72, 0x39, 0xD0} //MYC
#elif (IHU_DEVELOPER_CURRENT_WORKING_ENV_NAME == IHU_DEVELOPER_ENV_NAME_XX)		
	#define CFG_NVDS_TAG_BD_ADDRESS             {0x30, 0xEF, 0xA5, 0x72, 0x39, 0xD0} //XX
	...
	#define CFG_NVDS_TAG_BD_ADDRESS             {0x28, 0xEF, 0xA5, 0x72, 0x39, 0xD0} //LZH
