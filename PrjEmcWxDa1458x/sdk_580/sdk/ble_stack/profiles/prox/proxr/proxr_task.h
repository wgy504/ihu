...
enum
{
    ...
    /// LLS/IAS level update indication
    PROXR_LEVEL_UPD_IND,
};
...
/// Parameters of the @ref PROXR_LLS_ALERT_IND message
struct proxr_lls_alert_ind
{
    /// Connection handle
    uint16_t conhdl;
    /// Alert level
...
/// Parameters of the @ref PROXR_LEVEL_UPD_IND message
struct proxr_level_upd_ind
{
    /// Connection handle
    uint16_t conhdl;
    /// Alert level
