...
#if (BLE_CP_COLLECTOR || BLE_CP_SENSOR)
...
#define CPP_ERROR_INAPP_CONNECT_PARAMS  (0x80)
/// Improperly configured
#define CPP_ERROR_IMPROPERLY_CONFIGURED (0xFD)
/// Procedure in progress
#define CPP_ERROR_PROC_IN_PROGRESS (0xFE)


/// CP Measurement Value Max Length
#define CPP_CP_MEAS_MAX_LEN              (35)
/// CP Measurement Value Min Length
#define CPP_CP_MEAS_MIN_LEN                (4)
/// CP Measurement maximun pair size
#define CPP_CP_MEAS_MAX_PAIR_SIZE          (7)
...
#endif //(BLE_CP_COLLECTOR || BLE_CP_SENSOR)
