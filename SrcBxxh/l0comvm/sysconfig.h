 ...
 ***********************************************************************************/
	...
	//WATCH_DOG是否使能
	#define IHU_HARDWARE_WATCH_DOG_ENABLE 1
	#define IHU_HARDWARE_WATCH_DOG_DISABLE 2
	#define IHU_WATCH_DOG_SET_ENABLE_OR_DISABLE IHU_HARDWARE_WATCH_DOG_DISABLE

	//CRC是否使能
	#define IHU_HARDWARE_CRC_ENABLE 1
	#define IHU_HARDWARE_CRC_DISABLE 2
	#define IHU_CRC_SET_ENABLE_OR_DISABLE IHU_HARDWARE_CRC_DISABLE

	//RTC是否使能
	#define IHU_HARDWARE_RTC_ENABLE 1
	#define IHU_HARDWARE_RTC_DISABLE 2
	#define IHU_RTC_SET_ENABLE_OR_DISABLE IHU_HARDWARE_RTC_DISABLE
 ...
 ***********************************************************************************/
	...
	#define IHU_HARDWARE_RTC_ENABLE 1
	#define IHU_HARDWARE_RTC_DISABLE 2
	#define IHU_RTC_SET_ENABLE_OR_DISABLE IHU_HARDWARE_RTC_ENABLE
 ...
 ***********************************************************************************/
	...
	#define IHU_HARDWARE_WATCH_DOG_ENABLE 1
	#define IHU_HARDWARE_WATCH_DOG_DISABLE 2
	#define IHU_WATCH_DOG_SET_ENABLE_OR_DISABLE IHU_HARDWARE_WATCH_DOG_ENABLE
	
	//CRC是否使能
	#define IHU_HARDWARE_CRC_ENABLE 1
	#define IHU_HARDWARE_CRC_DISABLE 2
	#define IHU_CRC_SET_ENABLE_OR_DISABLE IHU_HARDWARE_CRC_ENABLE
