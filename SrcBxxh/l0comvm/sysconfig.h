 ...
 */
	...
	#define IHU_CCL_TIMER_DURATION_WORKING_STATUS_SCAN 2	
	//Series Port config
	#define IHU_SERIESPORT_NUM_FOR_GPS_DEFAULT  1
	//定义后台CLOUD连接到服务器
	#define IHU_CLOUDXHUI_HTTP_ADDRESS_LOCAL "http://127.0.0.1/test.php"
	...
	#define IHU_TRACE_DEBUG_ON IHU_TRACE_DEBUG_ALL_ON //利用以上标示位，确定TRACE的级别
	//TRACE开关，缺省打开
	#define IHU_TRACE_MSG_ON IHU_TRACE_MSG_MODE_ALL_BUT_TIME_OUT_AND_HEART_BEAT
	...
	#define IHU_CLOUDXHUI_BH_INTERFACE_STANDARD IHU_CLOUDXHUI_BH_INTERFACE_STANDARD_XML
	//DEBUG开关，缺省打开
	#define IHU_TRACE_DEBUG_ON IHU_TRACE_DEBUG_FAT_ON+IHU_TRACE_DEBUG_CRT_ON+IHU_TRACE_DEBUG_IPT_ON+IHU_TRACE_DEBUG_NOR_ON  //利用以上标示位，确定TRACE的级别

	//TRACE开关，缺省打开
	#define IHU_TRACE_MSG_ON  IHU_TRACE_MSG_MODE_ALL_BUT_TIME_OUT  //IHU_TRACE_MSG_MODE_ALL   
