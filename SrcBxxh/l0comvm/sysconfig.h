 ...
 ***********************************************************************************/
	...
	#define IHU_CCL_TIMER_DURATION_EVENT_REPORT_PEROID_SCAN  60 //为了测试目的，未来需要修改为28800  //8个小时一次
	...
	#define IHU_CLOUDXHUI_BH_INTERFACE_STANDARD IHU_CLOUDXHUI_BH_INTERFACE_STANDARD_XML
	//DEBUG开关，缺省打开
	#define IHU_TRACE_DEBUG_ON IHU_TRACE_DEBUG_INF_ON + IHU_TRACE_DEBUG_NOR_ON + IHU_TRACE_DEBUG_IPT_ON + IHU_TRACE_DEBUG_CRT_ON + IHU_TRACE_DEBUG_FAT_ON  //利用以上标示位，确定TRACE的级别 IHU_TRACE_DEBUG_INF_ON +
	//TRACE开关，缺省打开
	#define IHU_TRACE_MSG_ON  IHU_TRACE_MSG_MODE_ALL_BUT_TIME_OUT //IHU_TRACE_MSG_MODE_ALL_BUT_TIME_OUT_AND_HEART_BEAT
