 ...
 ***********************************************************************************/
	...
	#define IHU_CCL_TIMER_DURATION_EVENT_REPORT_PEROID_SCAN 28800  //8个小时一次
	#define IHU_CCL_TIMER_DURATION_LOCK_ACTIVE 268  //锁激活可以工作的时间为4.5分钟，之后就进入休眠状态，这里设置的小2S
	#define IHU_CCL_TIMER_DURATION_DIDO_TRIGGER_PERIOD_SCAN 3 //永恒的定时扫描外部是不是触发
	#define IHU_CCL_TIMER_DURATION_DIDO_WORKING_PERIOD_SCAN 1 //WORKING模式下外部传感器的定时扫描
	#define IHU_CCL_TIMER_DURATION_SPS_WORKING_PERIOD_SCAN 1 //WORKING模式下外部传感器的定时扫描
	#define IHU_CCL_TIMER_DURATION_I2C_WORKING_PERIOD_SCAN 1 //WORKING模式下外部传感器的定时扫描
	#define IHU_CCL_TIMER_DURATION_DCMI_WORKING_PERIOD_SCAN 1 //WORKING模式下外部传感器的定时扫描
	#define IHU_CCL_TIMER_DURATION_ADC_WORKING_PERIOD_SCAN 1 //WORKING模式下外部传感器的定时扫描
	...
	#define IHU_GPRS_SMS_CENTER_NUMBER  "+8613010314500"
	#define IHU_GPRS_SMS_TARGET_NUMBER  "+8613701629240"
