...
#define IHU_EMCWX_CURRENT_SW_DELIVERY 53 //001 = 0x01 (XQ.WEMC.SW.R01.456), starting from 100 as 2015/10/03
...
//= ZJL/XH, 2016 Dec.6, CURRENT_SW_DELIVERY R03.52 =>EMC68X项目
//= ZJL/XH, 2016 Dec.6, CURRENT_SW_DELIVERY R03.53 =>BFSC项目
