...
* 说明    : 无
*******************************************************************************/
void SPS_GPRS_SendData(char* buff, uint16_t len)
{    
	uint16_t i;
...
//* 说明    : 无
//*******************************************************************************/
//void SPS_RFID_SendData(char* buff, uint16_t len)
//{    
//	uint16_t i;
...
//* 说明    : 无
//*******************************************************************************/
//void SPS_BLE_SendData(char* buff, uint16_t len)
//{    
//	uint16_t i;
...
//* 说明    : 无
//*******************************************************************************/
//void SPS_SPARE1_SendData(char* buff, uint16_t len)
//{    
//	uint16_t i;
