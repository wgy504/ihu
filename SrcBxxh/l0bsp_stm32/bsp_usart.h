...
#define IHU_BSP_STM32_SPS_GPRS_REC_MAX_LEN 				IHU_MSG_BODY_L2FRAME_MAX_LEN
#define IHU_BSP_STM32_SPS_RFID_REC_MAX_LEN 				IHU_MSG_BODY_L2FRAME_MAX_LEN
#define IHU_BSP_STM32_SPS_BLE_REC_MAX_LEN 				IHU_MSG_BODY_L2FRAME_MAX_LEN
#define IHU_BSP_STM32_SPS_PRINT_REC_MAX_LEN 			IHU_MSG_BODY_L2FRAME_MAX_LEN
#define IHU_BSP_STM32_SPS_SPARE1_REC_MAX_LEN 			IHU_MSG_BODY_L2FRAME_MAX_LEN
#define IHU_BSP_STM32_SPS_SPARE2_REC_MAX_LEN 			IHU_MSG_BODY_L2FRAME_MAX_LEN
