...
//NC522, MF522模块
//本地定义的交换矩阵	
	#define BSP_STM32_SPI_MF522_CS_PORT       			CUBEMX_PIN_F2_SPI1_CS_GPIO_Port
	#define BSP_STM32_SPI_MF522_CS_PIN        			CUBEMX_PIN_F2_SPI1_CS_Pin
	#define BSP_STM32_SPI_MF522_CE_PORT      			 	CUBEMX_PIN_F2_SPI1_CE_GPIO_Port
	#define BSP_STM32_SPI_MF522_CE_PIN        			CUBEMX_PIN_F2_SPI1_CE_Pin
	#define BSP_STM32_SPI_MF522_CLK_PORT      			CUBEMX_PIN_F2_SPI1_SCK_GPIO_Port
	#define BSP_STM32_SPI_MF522_CLK_PIN       			CUBEMX_PIN_F2_SPI1_SCK_Pin
	#define BSP_STM32_SPI_MF522_MISO_PORT     			CUBEMX_PIN_F2_SPI1_MISO_GPIO_Port
	#define BSP_STM32_SPI_MF522_MISO_PIN      			CUBEMX_PIN_F2_SPI1_MISO_Pin
	#define BSP_STM32_SPI_MF522_MOSI_PORT     			CUBEMX_PIN_F2_SPI1_MOSI_GPIO_Port
	#define BSP_STM32_SPI_MF522_MOSI_PIN      			CUBEMX_PIN_F2_SPI1_MOSI_Pin
	#define BSP_STM32_SPI_MF522_IRQ_PORT      			CUBEMX_PIN_F2_SPI1_GPIO_RST_GPIO_Port
	#define BSP_STM32_SPI_MF522_IRQ_PIN       			CUBEMX_PIN_F2_SPI1_GPIO_RST_Pin
	#define BSP_STM32_SPI_MF522_RST_PORT      			CUBEMX_PIN_F2_SPI1_GPIO_RST_GPIO_Port
	#define BSP_STM32_SPI_MF522_RST_PIN       			CUBEMX_PIN_F2_SPI1_GPIO_RST_Pin
//有效的函数体
...
//NRF24L01
//本地定义的交换矩阵	
	#define BSP_STM32_SPI_NRF24L01_CS_PORT       CUBEMX_PIN_F2_SPI1_CS_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_CS_PIN        CUBEMX_PIN_F2_SPI1_CS_Pin
	#define BSP_STM32_SPI_NRF24L01_CE_PORT       CUBEMX_PIN_F2_SPI1_CE_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_CE_PIN        CUBEMX_PIN_F2_SPI1_CE_Pin
	#define BSP_STM32_SPI_NRF24L01_CLK_PORT      CUBEMX_PIN_F2_SPI1_SCK_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_CLK_PIN       CUBEMX_PIN_F2_SPI1_SCK_Pin
	#define BSP_STM32_SPI_NRF24L01_MISO_PORT     CUBEMX_PIN_F2_SPI1_MISO_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_MISO_PIN      CUBEMX_PIN_F2_SPI1_MISO_Pin
	#define BSP_STM32_SPI_NRF24L01_MOSI_PORT     CUBEMX_PIN_F2_SPI1_MOSI_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_MOSI_PIN      CUBEMX_PIN_F2_SPI1_MOSI_Pin
	#define BSP_STM32_SPI_NRF24L01_IRQ_PORT      CUBEMX_PIN_F2_SPI1_GPIO_RST_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_IRQ_PIN       CUBEMX_PIN_F2_SPI1_GPIO_RST_Pin
	#define BSP_STM32_SPI_NRF24L01_RST_PORT      CUBEMX_PIN_F2_SPI1_GPIO_RST_GPIO_Port
	#define BSP_STM32_SPI_NRF24L01_RST_PIN       CUBEMX_PIN_F2_SPI1_GPIO_RST_Pin
//有效的函数体
...
#define IHU_BSP_STM32_SPI_RFID522_HANDLER						hspi1
#define IHU_BSP_STM32_SPI_RFID522_HANDLER_ID  			1
//CCL=>RFID NRF24L01使用了SPI2接口，且做为接收工作方式
#define IHU_BSP_STM32_SPI_RFID_NRF24L01_HANDLER			hspi1
#define IHU_BSP_STM32_SPI_RFID_NRF24L01_HANDLER_ID  1
