...
{
	FSM_STATE_LEDPISCES_INITED = FSM_STATE_COMMON + 1,
...
enum GLOBAL_GALOWAG_CTRL_TABLE_ID
{
	...
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_SYS_START,
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_SYS_SHUT_DOWN,
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_SYS_FAULT,
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_LOCK1_TRIGGER,
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_LOCK2_TRIGGER,
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_LOCK3_TRIGGER,
	GALOWAG_CTRL_ID_CCL_BEEP_PATTERN_LOCK4_TRIGGER,
#elif (IHU_WORKING_PROJECT_NAME_UNIQUE_CURRENT_ID == IHU_WORKING_PROJECT_NAME_UNIQUE_STM32_IAP_ID)	
	GALOWAG_CTRL_ID_L3IAP_BEEP_PATTERN_SYS_START,
#endif
	GALOWAG_CTRL_ID_MAX,
};
