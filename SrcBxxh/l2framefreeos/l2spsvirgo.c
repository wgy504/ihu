...
OPSTAT fsm_spsvirgo_ccl_open_auth_inq(UINT8 dest_id, UINT8 src_id, void * param_ptr, UINT16 param_len)
{
	...
	//采用13.56MHz MFRC522无源RFID待调测=>目前的长度为16
	...
	//采用2.4G ISM NRF24L01有源RFID待调测=>目前的长度为16
...
//	}
  ...
  ret1 = ihu_vmmw_gprsmod_tcp_text_data_transmit_with_receive((char *)(pMsgOutput.buf), pMsgOutput.bufferLen, zIhuSpsvirgoMsgRcvBuf.buf, &(zIhuSpsvirgoMsgRcvBuf.length));	
