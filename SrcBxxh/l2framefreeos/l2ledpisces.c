...
*/
IhuFsmStateItem_t IhuFsmLedpisces[] =
{
  ...
  {MSG_ID_COM_INIT,       								FSM_STATE_LEDPISCES_INITED,            			fsm_ledpisces_init},
  {MSG_ID_COM_INIT_FB,       							FSM_STATE_LEDPISCES_INITED,            			fsm_com_do_nothing},

	//ANY state entry
  {MSG_ID_COM_INIT_FB,                    FSM_STATE_COMMON,                           fsm_com_do_nothing},
	{MSG_ID_COM_HEART_BEAT,                 FSM_STATE_COMMON,                           fsm_com_heart_beat_rcv},
	{MSG_ID_COM_HEART_BEAT_FB,              FSM_STATE_COMMON,                           fsm_com_do_nothing},
	{MSG_ID_COM_STOP,                       FSM_STATE_COMMON,                           fsm_ledpisces_stop_rcv},
  {MSG_ID_COM_RESTART,                    FSM_STATE_COMMON,                           fsm_ledpisces_restart},
	{MSG_ID_COM_TIME_OUT,                   FSM_STATE_COMMON,                           fsm_ledpisces_time_out},
...
#elif (IHU_WORKING_PROJECT_NAME_UNIQUE_CURRENT_ID == IHU_WORKING_PROJECT_NAME_UNIQUE_STM32_L3IAP_ID)	
	{GALOWAG_CTRL_ID_IAP_BEEP_PATTERN_SYS_START, GALOWAG_CTRL_STATE_OFF, 1, 10, 11, 22, 0, 0, ihu_l1hd_beep_f2board_on, ihu_l1hd_beep_f2board_off},
#endif	
