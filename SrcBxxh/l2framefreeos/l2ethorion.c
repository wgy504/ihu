...
IhuFsmStateItem_t IhuFsmEthorion[] =
{
 ...
 //Task level initialization
  {MSG_ID_COM_INIT,       								FSM_STATE_ETHORION_INITED,            			fsm_ethorion_init},
  {MSG_ID_COM_INIT_FB,       							FSM_STATE_ETHORION_INITED,            			fsm_com_do_nothing},

	//ANY state entry
  {MSG_ID_COM_INIT_FB,                    FSM_STATE_COMMON,                           fsm_com_do_nothing},
	{MSG_ID_COM_HEART_BEAT,                 FSM_STATE_COMMON,                           fsm_com_heart_beat_rcv},
	{MSG_ID_COM_HEART_BEAT_FB,              FSM_STATE_COMMON,                           fsm_com_do_nothing},
	{MSG_ID_COM_STOP,                       FSM_STATE_COMMON,                           fsm_ethorion_stop_rcv},
  {MSG_ID_COM_RESTART,                    FSM_STATE_COMMON,                           fsm_ethorion_restart},
	{MSG_ID_COM_TIME_OUT,                   FSM_STATE_COMMON,                           fsm_ethorion_time_out},
