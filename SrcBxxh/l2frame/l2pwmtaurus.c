...
FsmStateItem_t FsmPwmtaurus[] =
{
  ...
  {MSG_ID_COM_RESTART,        						FSM_STATE_PWMTAURUS_AVTIVE,         					fsm_pwmtaurus_restart},
  {MSG_ID_COM_STOP,												FSM_STATE_PWMTAURUS_AVTIVE,         					fsm_pwmtaurus_stop_rcv},
...
//		}
	...
	//设置状态机到目标状态
	if (FsmSetState(TASK_ID_PWMTAURUS, FSM_STATE_PWMTAURUS_AVTIVE) == FAILURE){
