/**
  ...
  * @file    STM32F2xx_IAP/binary_template/readme.txt 
...
2. Relocate the vector table at address 0x08004000, using the "NVIC_SetVectorTable"
   ...
   "VECT_TAB_OFFSET" defined in system_stm32f2xx.c file. 

The SysTick example provided within the STM32F2xx Standard Peripherals library 
...
@par Directory contents 
 ...
 - "STM32F2xx_IAP\binary_template\EWARM"
 - "STM32F2xx_IAP\binary_template\MDK-ARM"
 - "STM32F2xx_IAP\binary_template\RIDE"
 - "STM32F2xx_IAP\binary_template\TASKING"
 - "STM32F2xx_IAP\binary_template\TrueSTUDIO" 
     - These folders contains a pre-configured project that produces a binary
       image of SysTick example to be loaded with IAP.

  - "STM32F2xx_IAP\binary_template\inc": contains the binary_template firmware header files 
     - IAP/binary_template/inc/stm32f2xx_conf.h    Library Configuration file
     - IAP/binary_template/inc/stm32f2xx_it.h      Header for stm32f2xx_it.c
     - IAP/binary_template/inc/main.h              Header for main.c

 - "STM32F2xx_IAP\binary_template\src": contains the binary_template firmware source files 
     - IAP/binary_template/src/main.c              Main program
     - IAP/binary_template/src/stm32f2xx_it.c      Interrupt handlers
     - IAP/binary_template/src/system_stm32f2xx.c  STM32F2xx system source file
...
In order to load the SysTick example with the IAP, you must do the following:
 ...
 - EWARM
    ...
    - A binary file "STM322xG_EVAL_SysTick.bin" will be generated under 
      "STM322xG_EVAL\Exe" folder.  
 ...
 - RIDE
    ...
    - A binary file "STM322xG_EVAL_SysTick.bin" will be generated under this
      directory location. 
 ...
 - TASKING
    ...
    - A binary file "STM322xG-EVAL.bin" will be generated under this
      directory location. 
    - Finally load this image with IAP application
